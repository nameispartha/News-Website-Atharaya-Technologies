      ...
      <div className="container-page">
        ...
        <div className="mb-4">
          <div className="text-sm text-neutral-600 mb-2">
            <Link to="/" className="hover:text-yellow-600 transition-colors">Wion</Link> / Cricket
          </div>
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-5 bg-wionYellow"></div>
            <h1 className="text-[28px] font-bold">Cricket</h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <article className="flex flex-col">
              <div className="mb-4 relative">
                <img 
                  src="https://picsum.photos/seed/sri-lanka-cricket-hattrick/800/500" 
          ...
          <aside className="hidden lg:block space-y-6">
            ...
            <div className="border border-neutral-200 bg-white">
              ...
              <div className="aspect-[4/3] bg-neutral-200">
                <img src="https://picsum.photos/seed/ad-cricket-top/400/300" className="w-full h-full object-cover" alt="ad" />
              </div>
            </div>
            ...
            <div className="border border-neutral-200 bg-white">
              <div className="h-8 bg-neutral-100 flex items-center px-3 text-sm font-semibold">ADVERTISEMENT</div>
              <div className="aspect-[4/3] bg-neutral-200">
                <img src="https://picsum.photos/seed/ad-cricket-mid/400/300" className="w-full h-full object-cover" alt="ad" />
              </div>
            </div>
        ...
        <div className="lg:hidden">
          <div className="border border-neutral-200 bg-white mb-4">
            <div className="h-8 bg-neutral-100 flex items-center px-3 text-sm font-semibold">ADVERTISEMENT</div>
            <div className="aspect-[4/3] bg-neutral-200">
              <img src="https://picsum.photos/seed/ad-cricket-top-mobile/400/300" className="w-full h-full object-cover" alt="ad" />
            </div>
          </div>
          <div className="space-y-3">
            <SidebarArticle
